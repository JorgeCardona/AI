package jorge.cardona.concepts.jpa.controller;
...
import jorge.cardona.concepts.jpa.errors.ValidationResponse;
import jorge.cardona.concepts.jpa.repository.NatureInterfaceRepository;
import jorge.cardona.concepts.jpa.service.NatureService;
import jorge.cardona.concepts.jpa.util.ValidateErrors;
...
//    @Schema(accessMode = Schema.AccessMode.AUTO)
            ...
            responses = {
                    @ApiResponse(
                            content = @Content(mediaType = "application/json",
                                    schema = @Schema(implementation = NatureController.class))),
    ...
    @ResponseBody
    public ResponseEntity<List<NatureEntity>> natureJson(){
