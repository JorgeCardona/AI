...
__email__ = "jorge.cardona@tcs.com"
__status__ = "Produccion"
__copyright__ = "Copyright Diciembre de 2019, TDOCS"
__credits__ = "Jorge Cardona"
__license__ = "© Copyright - Tata Consultancy Services"
__version__ = "1.0.0"
__maintainer__ = "Tata Consultancy Services"
###########################################################
###########################################################
import logging
import json
